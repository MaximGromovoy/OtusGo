...
var _ interfaces.TransactionRepositoryInterface = (*TransactionsPostgresRepository)(nil)

type TransactionsPostgresRepository struct {
	db *postgresDatabase.PostgresDB
}

func NewTransactionsPostgresRepository(db *postgresDatabase.PostgresDB) (*TransactionsPostgresRepository, error) {
